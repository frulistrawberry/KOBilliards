...
public class PreliminaryAdapter extends BaseQuickAdapter<PreliminaryBean, BaseViewHolder> {
    public PreliminaryAdapter() {
        super(R.layout.layout_preliminaryfragment);
    }

    @Override
    protected void convert(BaseViewHolder helper, PreliminaryBean item) {
