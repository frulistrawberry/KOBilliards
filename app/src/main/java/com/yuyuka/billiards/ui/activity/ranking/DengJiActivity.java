...
public class DengJiActivity extends BaseListActivity {
    ...
    public static void launcher(Context context) {
        Intent intent = new Intent(context, DengJiActivity.class);
        context.startActivity(intent);
    }
    @Override
    protected void initView() {
        setContentView(R.layout.layout_dengjiactivity);
