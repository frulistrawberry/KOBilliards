...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.shape_or_circle;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.shape_gr_circle;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.shape_or_circle, R.drawable.shape_gr_circle);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        mIndicatorWidth = (mIndicatorWidth < 0) ? SizeUtils.dp2px(context, DEFAULT_INDICATOR_WIDTH) : mIndicatorWidth;
        mIndicatorHeight =
                (mIndicatorHeight < 0) ? SizeUtils.dp2px(context, DEFAULT_INDICATOR_WIDTH) : mIndicatorHeight;
        mIndicatorMargin =
                (mIndicatorMargin < 0) ? SizeUtils.dp2px(context, DEFAULT_INDICATOR_WIDTH) : mIndicatorMargin;
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.shape_or_circle
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
