 ...
 * 
 */
public class MyListBullet implements MyStyle, IARE_Style {

	private TextView mListBulletImageView;
	...
	public MyListBullet(AREditText editText, TextView imageView) {
		this.mEditText = editText;
		this.mListBulletImageView = imageView;
		setListenerForTextView(this.mListBulletImageView);
	}
