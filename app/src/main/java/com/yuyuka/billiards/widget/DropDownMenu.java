...
public class DropDownMenu extends LinearLayout {
    ...
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews, @NonNull View contentView) {
        ...
        popupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (ScreenUtils.getScreenHeight(getContext())*menuHeighPercent)));
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        LinearLayout mTabLayout = new LinearLayout(getContext());
        mTabLayout.setLayoutParams(new LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
        ...
        tab.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT));
        ...
        tabMenuView.addView(mTabLayout);
        //添加分割线
