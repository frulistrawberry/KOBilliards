 ...
 * @author Wenbin Liu
 */
public class MyListNumber implements MyStyle, IARE_Style {
    ...
    public MyListNumber(AREditText editText, TextView imageView) {
        this.mEditText = editText;
        this.mListNumberImageView = imageView;
        setListenerForTextView(this.mListNumberImageView);
    }
